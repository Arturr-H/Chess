...
let controller_image = "/pieces/white/knight.svg";
let controlled_piece = null;
let controlled_piece_name = "";
let minutes = 0;
...
const display_games = (games) => {
    ...
    games.forEach(game => {
        ...
        GAMES_CONTAINER === null || GAMES_CONTAINER === void 0 ? void 0 : GAMES_CONTAINER.appendChild(el);
    });
};
...
const generate_minutes_selection_grid = () => {
    ...
    for (let i = 0; i < 5; i++) {
        for (let j = 0; j < 5; j++) {
            ...
            if (j == 2 && i == 2) {
                ...
                /* Move knight */
                knight === null || knight === void 0 ? void 0 : knight.addEventListener("mousedown", (e) => {
    ...
    knight_places.forEach(e => {
        ...
        tile === null || tile === void 0 ? void 0 : tile.classList.add("highlight");
    });
};
const rook_places = [
    [[4, 2], "Create"],
    ...
    for (let i = 0; i < 5; i++) {
        for (let j = 0; j < 5; j++) {
            ...
            if (j == 2 && i == 2) {
                ...
                /* Move rook */
                rook === null || rook === void 0 ? void 0 : rook.addEventListener("mousedown", (e) => {
                    is_dragging_controller = true;
                    CONTROLLER_GHOST_PIECE.style.left = `${e.x}px`;
                    CONTROLLER_GHOST_PIECE.style.top = `${e.y}px`;
                    CONTROLLER_GHOST_PIECE.style.display = "block";
...
const move_knight = (to) => {
    knight_places.forEach((e, index) => {
        ...
        let tile = document.getElementById(`minute-tile-${e[0][0]}-${e[0][1]}`);
        tile === null || tile === void 0 ? void 0 : tile.classList.add("fade-out");
    ...
    el === null || el === void 0 ? void 0 : el.appendChild(knight);
    setTimeout(() => {
...
const move_rook = (to) => {
    ...
    el.style.marginTop = "100%";
    el.style.opacity = "0";
    el === null || el === void 0 ? void 0 : el.appendChild(rook);
    setTimeout(() => {
        if (to[0] == 0) {
            STATUS_CONTAINER.style.display = "none";
